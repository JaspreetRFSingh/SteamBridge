...
/**
 * REST Source Task that polls API endpoints and produces Kafka records.
 */
public class RestSourceTask extends SourceTask {
    ...
    public void start(Map<String, String> props) {
        ...
        log.info("Starting REST Source Task for endpoint: {}", config.getString(RestSourceConnectorConfig.ENDPOINT_URL));
    }
    ...
    public List<SourceRecord> poll() throws InterruptedException {
        ...
        if (elapsed < pollInterval) {
            Thread.sleep(pollInterval - elapsed);
        }
    ...
    @Override
    public void stop() {
        log.info("Stopping REST Source Task");
    }
}
